...
static float *game_colours(frontend *fe, int *ncolours)
{
    ...
    ret[COL_MONSTER_EYES * 3 + 0] = ret[COL_BACKGROUND * 3 + 0];
    ret[COL_MONSTER_EYES * 3 + 1] = ret[COL_BACKGROUND * 3 + 1];
    ret[COL_MONSTER_EYES * 3 + 2] = ret[COL_BACKGROUND * 3 + 2];
                         ...
                         int tilesize, bool hflash, int monster)
{
    ...
    if (monster == 1) {                /* ghost */
        ...
        poly[i++] = y+1*tilesize/8;
        draw_polygon(dr, poly, i/2, COL_MONSTER_EYES, black);
        i = 0;
        poly[i++] = x+3*tilesize/16;
        poly[i++] = y+1*tilesize/8;
        poly[i++] = x+2*tilesize/16;
