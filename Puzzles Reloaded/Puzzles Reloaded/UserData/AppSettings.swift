...
struct AppSettings: Codable {
    ...
    var lastSeenReleaseNotesVersion: Int = 0
    ...
    init(from decoder: Decoder) throws {
        ...
        lastSeenReleaseNotesVersion = try values.decodeIfPresent(Int.self, forKey: .lastSeenReleaseNotesVersion) ?? 0
