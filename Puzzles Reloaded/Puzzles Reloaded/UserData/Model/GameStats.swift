...
struct NewGameSettings {
    ...
    var stats: NewGameStats = NewGameStats()
    ...
    var customPuzzlePresets: [NewCustomGamePreset] = []
...
struct NewGameHistory: Codable, Identifiable {
    var id = UUID()
    var gameId: String = ""
...
struct NewCustomGamePreset: Codable, Identifiable {
    var id = UUID()
    var sortOrder: Int = 0
    var name: String = ""
