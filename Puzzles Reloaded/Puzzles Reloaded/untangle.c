// NOTE: For the short tem, I've copied untangle locally to pull in the minor changes I needed to make to it. I'll plan on removing this file once I submit the changes upstream.
...
#  define CIRCLE_RADIUS 6 /* Makes the circle radius proportional to the determined tile size */
#endif
