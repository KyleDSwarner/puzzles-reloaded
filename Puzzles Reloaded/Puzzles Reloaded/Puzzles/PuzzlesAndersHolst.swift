...
// These are commented out as the games are currently removed from the package.
// To reintroduce these games, we must apply the modified `midend.c` to support.
...
/*
 ...
 puzzle_alphacrypt,
 puzzle_factorcross,
 // puzzle_identifier, // Not suitable for tap-based controls
 puzzle_kakuro,
 puzzle_supermaze
 ]}
 ...
 customParamInfo: String(localized: "supermaze_params", table: "Puzzles"),
