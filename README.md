...
In addition to the games from the main collections, it also provides a set of new games by [x-sheep](https://github.com/x-sheep/puzzles-unreleased) and [Steffen Bauer](https://github.com/SteffenBauer/sgtpuzzles-extended). 54 games in total are currently supported!
